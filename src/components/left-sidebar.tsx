        ...
        <div className="sticky top-0 z-10 bg-white dark:bg-zinc-900 border-b border-gray-200 dark:border-zinc-800 p-6">
          <div className="flex flex-col items-center relative">
            ...
            <div className="absolute group">
              ...
              <div className="absolute left-14 top-18 hidden group-hover:flex z-50 bg-white dark:bg-zinc-800 p-2 rounded-md shadow-md whitespace-pre">
              ...
              {/* Second Hover Box */}
              <div className="absolute left-8 top-28 hidden group-hover:flex z-60 bg-white dark:bg-zinc-800 p-2 rounded-md shadow-md whitespace-nowrap">
                <span className="text-xs text-gray-800 dark:text-gray-100">
